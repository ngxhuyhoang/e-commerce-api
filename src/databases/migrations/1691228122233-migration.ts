...
export class Migration1691228122233 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`name\` varchar(255) NOT NULL, \`price\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, INDEX \`IDX_0806c755e0aca124e67c0cf6d7\` (\`id\`), INDEX \`IDX_21ba1fd3e61583222b585e73e6\` (\`is_deleted\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
